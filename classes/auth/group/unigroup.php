...
class Auth_Group_UniGroup extends \Auth_Group_Driver
{
	...
	{
		static::$_valid_groups = array_keys(\Config::get('uniauth.groups', array()));
	}

	protected $config = array(
		'drivers' => array('acl' => array('UniAcl'))
	);
	...
	public function get_name($group = null)
	{
		...
		return \Config::get('uniauth.groups.'.$group.'.name', null);
	}
	...
	public function get_roles($group = null)
	{
		...
		$groups = \Config::get('uniauth.groups');
